      ...
      <Grid container className={classes.root} spacing={1}>
        ...
        <Grid item xs>
          <Autocomplete
            ...
            value={1}
            size="small"
            inputParams={{ label: 'Тип воздушного судна', name: 'aircraftType' }}
        ...
        <Grid item xs>
          <Autocomplete
            ...
            value={1}
            size="small"
            inputParams={{ label: 'Точка вылета', name: 'airdromDepart' }}
            onChange={(event, newValue) => {
              // if (typeof newValue === 'string') {
              //   setTimeout(() => {
              //     this.toggleOpen(true);
        ...
        <Grid item xs>
          <Autocomplete
            ...
            value={1}
            size="small"
            inputParams={{ label: 'Точка посадки', name: 'airdromLanding' }}
            onChange={(event, newValue) => {
              // if (typeof newValue === 'string') {
              //   setTimeout(() => {
              //     this.toggleOpen(true);
